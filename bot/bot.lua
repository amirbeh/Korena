...
chats = {}
plugins = {}
helper_id = 00000000 --Put Your Helper Bot ID Here
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    info_text = [[》KOrena v1.0
Based on https://valtman.name/telegram-cli

》https://github.com/hamidreza7517/korena
