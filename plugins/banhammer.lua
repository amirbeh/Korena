...
user = msg.from.id
   if msg.to.type ~= 'pv' then
 if (matches[1]:lower() == "kick" and is_mod(msg) and not Clang) or (matches[1] == "اخراج" and is_mod(msg) and Clang) then
...
channel_unblock(msg.to.id, matches[2])
 ...
 if (matches[1]:lower() == "dellall" and is_mod(msg) and not Clang) or (matches[1] == "حذف پیام" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
tdcli.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
 ...
 if (matches[1]:lower() == "banall" and is_admin(msg) and not Clang) or (matches[1] == "سوپر بن" and is_admin(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
kick_user(matches[2], msg.to.id)
 ...
 if (matches[1]:lower() == "unbanall" and is_admin(msg) and not Clang) or (matches[1] == "حذف سوپر بن" and is_admin(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." از محرومیت گروه های ربات خارج شد*", 0, "md")
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   ...
   if msg.to.type ~= 'pv' then
 if (matches[1]:lower() == "ban" and is_mod(msg) and not Clang) or (matches[1] == "بن" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
kick_user(matches[2], msg.to.id)
 ...
 if (matches[1]:lower() == "unban" and is_mod(msg) and not Clang) or (matches[1] == "حذف بن" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
return tdcli.sendMessage(msg.to.id, msg.id, 0, "*کاربر "..matches[2].." از محرومیت گروه خارج شد*", 0, "md")
 ...
 if (matches[1]:lower() == "silent" and is_mod(msg) and not Clang) or (matches[1] == "سکوت" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
 ...
 if (matches[1]:lower() == "unsilent" and is_mod(msg) and not Clang) or (matches[1] == "حذف سکوت" and is_mod(msg) and Clang) then
if not matches[2] and msg.reply_id then
    tdcli_function ({
      ID = "GetMessage",
      chat_id_ = msg.to.id,
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
  ...
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ...
      username_ = matches[2]
		...
		if (matches[1]:lower() == "clean" and is_owner(msg) and not Clang) or (matches[1] == "پاک کردن" and is_owner(msg) and Clang) then
     ...
     if not lang then
			...
			if (matches[2]:lower() == 'silentlist' and not Clang) or (matches[2] == 'لیست سکوت' and Clang) then
       ...
       if not lang then
		...
		if (matches[1]:lower() == "clean" and is_sudo(msg) and not Clang) or (matches[1] == "پاک کردن" and is_sudo(msg) and Clang) then
 ...
 if (matches[1]:lower() == "gbanlist" and is_admin(msg) and not Clang) or (matches[1] == "لیست سوپر بن" and is_admin(msg) and Clang) then
  return gbanned_list(msg)
 end
   if msg.to.type ~= 'pv' then
 if (matches[1]:lower() == "silentlist" and is_mod(msg) and not Clang) or (matches[1] == "لیست سکوت" and is_mod(msg) and Clang) then
  return silent_users_list(chat)
 end
 if (matches[1]:lower() == "banlist" and is_mod(msg) and not Clang) or (matches[1] == "لیست بن" and is_mod(msg) and Clang) then
